...
import { auth } from "@/auth"; // Asegúrate de que auth esté importado correctamente

export default async function Home() {
  const session = await auth(); // Obtén la sesión para verificar el rol del usuario
